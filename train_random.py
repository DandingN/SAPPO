...
def make_env(config):
    return SubprocVecEnv([lambda: RandomEnv(config) for _ in range(config.n_envs)])
...
if __name__ == "__main__":
    ...
    model_config = SimpleNamespace(**{
        ...
        "tensorboard_log": "log/RecurrentPPO/20250502_16",  # todo TensorBoard日志路径（若为None则不记录）
